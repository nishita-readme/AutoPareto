...
The tutorial uses two publicly available mouse cortex datasets from GEO:
 
| Role | Accession | What to download |
|---|---|---|
...
| Reference atlas | [GSE115746](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE115746) | `GSE115746_exon_counts.csv.gz`, `GSE115746_complete_metadata_28706-cells.csv.gz` |
 
Place them in:
```
data/
├── test/raw/      ← query files go here
└── ref/raw/       ← reference files go here
```
